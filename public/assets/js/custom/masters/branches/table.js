    ...
    var e, t, n, r, o = document.getElementById("kt_table_users"),
        ...
        l = () => {
            ...
            c.forEach((e => {
                ...
                Swal.fire({
                    text: "Are you sure you want to delete selected branches?",
                    icon: "warning",
                    showCancelButton: !0,
                    buttonsStyling: !1,
                    confirmButtonText: "Yes, delete!",
                    ...
                    const delForm = document.getElementById("deleteBranchBulk")
                    const data = new URLSearchParams();
                    for (const pair of new FormData(delForm)) {
                        data.append(pair[0], pair[1]);
                    }
                    fetchPostRequest("/masters/branches/delete", data, "Branches Deleted Successfully")
