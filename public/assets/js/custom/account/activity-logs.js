...
var KTDatatablesExample = function() {
    ...
    return {
        init: function() {
            (t = document.querySelector("#kt_datatable_example")) && (t.querySelectorAll("tbody tr").forEach((t => {
                ...
                }).container().appendTo($("#kt_datatable_example_buttons")), document.querySelectorAll("#kt_datatable_example_export_menu [data-kt-export]").forEach((t => {
